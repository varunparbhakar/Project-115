const ZOMBIE_IMAGE_WIDTH = 780
const ZOMBIE_IMAGE_HEIGHT = 780
const ZOMBIE_IMAGE_SCALE = 0.5
const ZOMBIE_IMAGE_RADIUS = 100

class Zombie extends GameObject {
    constructor(posX, posY) {
        super(posX, posY, "Assets/Images/Characters/Zombies/Zombie.png",
            0, 0,
    ...
    updateCollision() {
        this.bc.x = this.posX + (ZOMBIE_IMAGE_WIDTH/2) * ZOMBIE_IMAGE_SCALE
        this.bc.y = this.posY + (ZOMBIE_IMAGE_HEIGHT/2) * ZOMBIE_IMAGE_SCALE
    }

    update() {
        super.update();
        this.updateCollision();
        // this.angle = this.rotationHandler();
        this.flipHandler()
    }
    flipHandler() {
    ...
    draw() {
        ...
        // tempCtx.drawImage(this.asset, 0, 0); //SCALE
        // tempCtx.restore();
        //
